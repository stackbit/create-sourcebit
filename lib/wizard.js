      ...
      return new Promise(resolve => {
        setTimeout(() => {
          resolve([
            {
              package: {
                name: "../../sourcebit-plugin-page-map",
                version: "0.1.0",
      ...
      const questions = [
        {
          ...
          name: "sourcePlugins",
          message:
            "Select one or more source plugins. These plugins define all your data sources.",
        ...
        },
        {
          ...
          message:
            "Select one or more transformation plugins. These plugins transform and augment the data coming from the data sources.",
